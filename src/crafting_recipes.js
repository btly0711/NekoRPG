...
(function(){
    ...
    smelting_recipes.items3["晶化合金(x3)"] = new ItemRecipe({
        name: "晶化合金(x3)",
        recipe_type: "material",
        materials: [{material_id: "万载冰髓锭", count: 2},{material_id: "镶晶盾牌", count: 3},{material_id: "冰宫鳞片",count: 2}], 
...
(function(){
    ...
    alchemy_recipes.items3["极寒织料"] = new ItemRecipe({
        name: "极寒织料",
        recipe_type: "material",
        materials: [{material_id: "多孔冰晶", count: 2},{material_id: "光环杖芯", count: 1},{material_id: "冰宫鳞片", count: 1}], 
