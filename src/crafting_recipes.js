...
(function(){
    ...
    crafting_recipes.items["结界湖之心"] = new ItemRecipe({
        name: "结界湖之心",
        id: "结界湖之心",
        recipe_type: "items",
    ...
    crafting_recipes.items["三相徽章"] = new ItemRecipe({
        name: "三相徽章",
        id: "三相徽章",
        recipe_type: "items",
        materials: [{material_id: "水火徽章", count: 1},{material_id:"废墟精华",count:99},{material_id:"A7·能量核心",count:99}],
...
(function(){
    ...
    smelting_recipes.items2["熔炼海绿"] = new ItemRecipe({
        name: "熔炼蓝金",
        recipe_type: "material",
        materials: [{material_id: "绿色刀币", count: 1},{material_id: "A7·能量核心", count: 8},{material_id:"废墟精华", count: 4}], 
        result: {result_id: "海绿锭", count: 4},
        success_chance: [0.5,1],
        recipe_level: [27,35],
        recipe_skill: "Smelting",
    });
